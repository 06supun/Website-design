...
if(isset($_POST['btnsubmit'])){
    ...
    $sql = "INSERT INTO student(fullname,contact,address,gender,username,password) VALUES('$fullname',$contact,'$address','$gender','$username','$password')";
...
<div class="container">
    <div class="row">
        ...
        <h1 class="display-4">Student Registration</h1><br>
