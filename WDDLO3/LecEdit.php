...
<div class="container">
    <div class="row">
        ...
        <h1 class="display-4">Lecturer Edit</h1><br>
...
if(isset($_POST['btnsave'])){
    ...
    $sqlUpdate = "UPDATE lecturer SET fullname = '$fullname',contact='$contact',address='$address',username='$username',password='$password' WHERE id = $id;";
